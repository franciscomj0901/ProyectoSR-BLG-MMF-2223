...
- Debian6-Pruebas:
  ...
  - Álvaro:<br>
  ![conf.local Debian6 guillermo](imagenes/guillermo/named.conf.local.ej4(2).PNG)<img src="imagenes/alvaro/named.conf.local jta d6.jpg">
...
- dbservidores (Que se encuentra en el Debian5.pruebas)<br>
  ...
  - Álvaro:<br>
![db.servidores Guille](imagenes/guillermo/db.servidores.PNG)<img src="imagenes/alvaro/db.servidores.com jta d5.jpg">
-db.routers (Que se encuentra en el Debian5-pruebas)<br>
  ...
  - Álvaro:
![db.servidores Guille](imagenes/guillermo/db.servidores.PNG)<img src="imagenes/alvaro/db.routers.com jta d5.jpg"><br><br>
-db.equipos (Que se encuentra en el Debian6-pruebas)<br>
  ...
  - Álvaro: <br>
 ![db.servidores Guille](imagenes/guillermo/db.servidores.PNG)<img src="imagenes/alvaro/db.equipos.com jta d6.jpg">
